...
If you wish to save H264 to disk checkout out [save-to-webm](https://github.com/carrotsong/example-webrtc-applications/tree/master/save-to-webm)

## Instructions
### Download save-to-disk
```
export GO111MODULE=on
go get github.com/carrotsong/webrtc/v3/examples/save-to-disk
```
