...
<p align="center">
  ...
  <a href="https://pkg.go.dev/github.com/carrotsong/webrtc/v3"><img src="https://pkg.go.dev/badge/github.com/carrotsong/webrtc/v3" alt="PkgGoDev"></a>
  ...
  <a href="https://goreportcard.com/report/github.com/carrotsong/webrtc"><img src="https://goreportcard.com/badge/github.com/carrotsong/webrtc" alt="Go Report Card"></a>
...
Pion WebRTC v3.0.0 has started! See the [release notes](https://github.com/carrotsong/webrtc/wiki/Release-WebRTC@v3.0.0) to learn about new features and breaking changes.

Until `v3.0.0` has been tagged using `v2` is suggested. Check the [tags](https://github.com/carrotsong/webrtc/tags) for the latest `v2` release.
...
**[example-webrtc-applications](https://github.com/carrotsong/example-webrtc-applications)** contains more full featured examples that use 3rd party libraries.

**[awesome-pion](https://github.com/carrotsong/awesome-pion)** contains projects that have used Pion, and serve as real world examples of usage.

**[GoDoc](https://pkg.go.dev/github.com/carrotsong/webrtc/v3)** is an auto generated API reference. All our Public APIs are commented.

**[FAQ](https://github.com/carrotsong/webrtc/wiki/FAQ)** has answers to common questions. If you have a question not covered please ask in [Slack](https://pion.ly/slack) we are always looking to expand it.
...
[Wiki page on WebAssembly Development](https://github.com/carrotsong/webrtc/wiki/WebAssembly-Development-and-Testing)
for more information.

### Roadmap
The library is in active development, please refer to the [roadmap](https://github.com/carrotsong/webrtc/issues/9) to track our major milestones.
We also maintain a list of [Big Ideas](https://github.com/carrotsong/webrtc/wiki/Big-Ideas) these are things we want to build but don't have a clear plan or the resources yet.
